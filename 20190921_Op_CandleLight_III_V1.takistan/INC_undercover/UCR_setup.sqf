...
_civilianVehicleArray = ["isc_pesh_offroad_M2_b","B_Quadbike_01_F","isc_is_offroad_M2_o"];
...
_incogFactions = ["isc_is_o"]; //Array of enemy factions whose items and vehicles will allow the player to impersonate the enemy
